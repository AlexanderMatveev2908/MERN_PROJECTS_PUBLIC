...
//     }
//     try {
//       const res = await foodInstance.post("/", formData);
//       if (res.data?.ok)
//         toast.success(count + `${food.name} added successfully`);
//       else toast.error(`${food.name} sorry buddy`);
//     } catch (err) {
//       console.log(err);
//     } finally {
//       setLoading(false);
